...
import math
# import seaborn
#%matplotlib tk图片显示在另外的窗口
#%matplotlib inline图片显示在控制台
...
#     plt.show()
    ...
    # 7. 绘制三维图像
     ...
     ax.plot_surface(x, y, z, rstride=5, cstride=5, cmap=cm.ocean, linewidth=0.5)
     plt.show()
    ...
    # # 8.2 使用scipy计算函数极值
    # a = opt.fmin(f, 1)#简单Nelder-Mead算法
    # b = opt.fmin_cg(f, 1)#非线性共轭梯度法
    # c = opt.fmin_bfgs(f, 1)#拟Newton法
    # print a, 1/a, math.e
    # print b
    # print c
