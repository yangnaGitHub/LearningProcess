...
def get_page_content(cur_url, index, depth):
    ...
    try:
        ...
        #fo.write(html_page)
        #fo.close()
        with hdfs_client.write('%s%s.html' % (dir_name, filename)) as writer:
...
if __name__ == "__main__":
    ...
    hdfs_client = InsecureClient("http://localhost:50070")#InsecureClient('http://54.223.92.169:50070', user='ec2-user')
