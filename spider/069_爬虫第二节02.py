# -*- coding: utf-8 -*-
"""
Created on Mon Mar 20 18:28:03 2017
...
class CrawlDatabaseManager:
    ...
    def __init__(self, max_num_thread):
        try:
            cnx = mysql.connector.connect(host=self.SERVER_IP, user='root', password='natasha0320')
        ...
        dbconfig = {
            ...
            "user": "root",
            "password": "natasha0320",
            "host": self.SERVER_IP,
            }
        self.cnxpool = mysql.connector.pooling.MySQLConnectionPool(pool_name="mypool", pool_size=max_num_thread, **dbconfig)
