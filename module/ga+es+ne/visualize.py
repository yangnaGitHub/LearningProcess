# -*- coding: utf-8 -*-
"""
Created on Tue Mar  5 18:21:50 2019
...
def draw_net(config, genome, view=False, filename=None, node_names=None, show_disabled=True,
    ...
    assert type(node_names) is dict#声明其布尔值必须为真的判定
    ...
    for cg in genome.connections.values():
        if cg.enabled or show_disabled:
            ...
            style = 'solid' if cg.enabled else 'dotted'#enable是实体
            color = 'green' if cg.weight > 0 else 'red'#weight大于0是绿色
